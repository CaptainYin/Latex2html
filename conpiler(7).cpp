...
void printsymbol(ofstream&out, symbol c)
{
	out << "<div style=\"position: absolute;top: " << c.top << "px; left:" << c.left << "px;\"><" ;
	out << "span style=\"font-size:" << c.front_size << "px; font-style:" << c.font_style << ";";
	out << "line-height:100%;\">";
	out << c.ch  ;
	out << "</span></div>" << endl;
}
